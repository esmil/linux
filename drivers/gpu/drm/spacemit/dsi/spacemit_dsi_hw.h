...
#define APMU_LCD_SW_SLEEP		BIT(7)
...
//DSI_VPN_CTRL_0 0x100
#define CFG_VPN_DLY_CNT_SHIFT 16
#define CFG_VPN_HSYNC_GRANTEE_EN_SHIFT 10
#define CFG_VPN_HSYNC_GRANTEE_EN (1 << CFG_VPN_HSYNC_GRANTEE_EN_SHIFT)
#define CFG_VPN_1LN_DLY_SHIFT 8
#define CFG_VPN_1LN_DLY (1 << CFG_VPN_1LN_DLY_SHIFT)
#define CFG_VPN_TX_DLY_CNT_SHIFT 0
