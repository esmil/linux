...
#define RDMA2_BASE_ADDR (RDMA0_BASE_ADDR + 0xb000)
#define RDMA3_BASE_ADDR (RDMA0_BASE_ADDR + 0xc000)
...
#define SCALER_SIZE 0x400
#define SCALER0_ONLINE_BASE_ADDR 0x14000
