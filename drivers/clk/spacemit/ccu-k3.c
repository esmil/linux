...
CCU_FACTOR_DEFINE(i2s_bclk_factor, CCU_PARENT_HW(i2s1_sysclk), 2, 1);
/*
...
CCU_GATE_DEFINE(pciea_slv_clk, CCU_PARENT_HW(pll2_d6), APMU_PCIE_CLK_RES_CTRL_A, BIT(1) | BIT(0), 0);
CCU_GATE_DEFINE(pcieb_mstr_clk, CCU_PARENT_HW(axi_clk), APMU_PCIE_CLK_RES_CTRL_B, BIT(2), 0);
CCU_GATE_DEFINE(pcieb_slv_clk, CCU_PARENT_HW(pll2_d6), APMU_PCIE_CLK_RES_CTRL_B, BIT(1) | BIT(0), 0);
CCU_GATE_DEFINE(pciec_mstr_clk, CCU_PARENT_HW(axi_clk), APMU_PCIE_CLK_RES_CTRL_C, BIT(2), 0);
CCU_GATE_DEFINE(pciec_slv_clk, CCU_PARENT_HW(pll2_d6), APMU_PCIE_CLK_RES_CTRL_C, BIT(1) | BIT(0), 0);
CCU_GATE_DEFINE(pcied_mstr_clk, CCU_PARENT_HW(axi_clk), APMU_PCIE_CLK_RES_CTRL_D, BIT(2), 0);
CCU_GATE_DEFINE(pcied_slv_clk, CCU_PARENT_HW(pll2_d6), APMU_PCIE_CLK_RES_CTRL_D, BIT(1) | BIT(0), 0);
...
/* RPMU clocks start */
CCU_DIV_FC_DEFINE(rcpu_apb_clk,  CCU_PARENT_HW(rcpu_clk), RCPU5_RCPU_BUS_CLK_CTRL, BIT(8), 3, 3, 0);
...
static const struct clk_parent_data rcan_parents[] = {
	CCU_PARENT_HW(pll6_20),
	CCU_PARENT_HW(pll6_40),
	CCU_PARENT_HW(pll6_80),
};
...
static const struct clk_parent_data rspi_parents[] = {
	CCU_PARENT_HW(pll1_aud_24p5),
	CCU_PARENT_HW(pll1_aud_245p7),
	CCU_PARENT_HW(pll1_d96_25p6),
};
...
static const struct clk_parent_data ri2c_parents[] = {
	CCU_PARENT_HW(pll1_aud_24p5),
	CCU_PARENT_HW(pll1_aud_245p7),
	CCU_PARENT_HW(pll1_d96_25p6),
};
...
static const struct clk_parent_data rpwm_parents[] = {
	CCU_PARENT_HW(pll1_aud_245p7),
	CCU_PARENT_HW(pll1_aud_24p5),
};
...
static struct clk_hw *k3_ccu_rcpu_sysctrl_hws[] = {
	[CLK_RCPU_SYSCTRL_RCAN0]		= &rcan0_clk.common.hw,
	[CLK_RCPU_SYSCTRL_RCAN1]		= &rcan1_clk.common.hw,
	[CLK_RCPU_SYSCTRL_RCAN2]		= &rcan2_clk.common.hw,
	[CLK_RCPU_SYSCTRL_RCAN3]		= &rcan3_clk.common.hw,
	[CLK_RCPU_SYSCTRL_RCAN4]		= &rcan4_clk.common.hw,
	[CLK_RCPU_SYSCTRL_RCAN0_BUS]		= &rcan0_bus_clk.common.hw,
	[CLK_RCPU_SYSCTRL_RCAN1_BUS]		= &rcan1_bus_clk.common.hw,
	[CLK_RCPU_SYSCTRL_RCAN2_BUS]		= &rcan2_bus_clk.common.hw,
	[CLK_RCPU_SYSCTRL_RCAN3_BUS]		= &rcan3_bus_clk.common.hw,
	[CLK_RCPU_SYSCTRL_RCAN4_BUS]		= &rcan4_bus_clk.common.hw,
	[CLK_RCPU_SYSCTRL_RIRC0]		= &rirc0_clk.common.hw,
	[CLK_RCPU_SYSCTRL_RIRC1]		= &rirc1_clk.common.hw,
	[CLK_RCPU_SYSCTRL_RESPI_SCLK_SRC]	= &respi_sclk_src.common.hw,
	[CLK_RCPU_SYSCTRL_RESPI_SCLK]		= &respi_sclk.common.hw,
	[CLK_RCPU_SYSCTRL_REMAC_BUS]		= &remac_bus_clk.common.hw,
	[CLK_RCPU_SYSCTRL_REMAC_REF]		= &remac_ref_clk.common.hw,
	[CLK_RCPU_SYSCTRL_REMAC_1588]		= &remac_1588_clk.common.hw,
...
static struct clk_hw *k3_ccu_rcpu_uartctrl_hws[] = {
	[CLK_RCPU_UARTCTRL_RUART0]		= &ruart0_clk.common.hw,
	[CLK_RCPU_UARTCTRL_RUART1]		= &ruart1_clk.common.hw,
	[CLK_RCPU_UARTCTRL_RUART2]		= &ruart2_clk.common.hw,
	[CLK_RCPU_UARTCTRL_RUART3]		= &ruart3_clk.common.hw,
	[CLK_RCPU_UARTCTRL_RUART4]		= &ruart4_clk.common.hw,
	[CLK_RCPU_UARTCTRL_RUART5]		= &ruart5_clk.common.hw,
	[CLK_RCPU_UARTCTRL_RUART0_BUS]		= &ruart0_bus_clk.common.hw,
	[CLK_RCPU_UARTCTRL_RUART1_BUS]		= &ruart1_bus_clk.common.hw,
	[CLK_RCPU_UARTCTRL_RUART2_BUS]		= &ruart2_bus_clk.common.hw,
	[CLK_RCPU_UARTCTRL_RUART3_BUS]		= &ruart3_bus_clk.common.hw,
	[CLK_RCPU_UARTCTRL_RUART4_BUS]		= &ruart4_bus_clk.common.hw,
	[CLK_RCPU_UARTCTRL_RUART5_BUS]		= &ruart5_bus_clk.common.hw,
};
...
static struct clk_hw *k3_ccu_rcpu_spictrl_hws[] = {
	[CLK_RCPU_SPICTRL_RSPI0]		= &rspi0_clk.common.hw,
	[CLK_RCPU_SPICTRL_RSPI1]		= &rspi1_clk.common.hw,
	[CLK_RCPU_SPICTRL_RSPI2]		= &rspi2_clk.common.hw,
	[CLK_RCPU_SPICTRL_RSPI0_BUS]		= &rspi0_bus_clk.common.hw,
	[CLK_RCPU_SPICTRL_RSPI1_BUS]		= &rspi1_bus_clk.common.hw,
	[CLK_RCPU_SPICTRL_RSPI2_BUS]		= &rspi2_bus_clk.common.hw,
};
...
static struct clk_hw *k3_ccu_rcpu_i2cctrl_hws[] = {
	[CLK_RCPU_I2CCTRL_RI2C0]		= &ri2c0_clk.common.hw,
	[CLK_RCPU_I2CCTRL_RI2C1]		= &ri2c1_clk.common.hw,
	[CLK_RCPU_I2CCTRL_RI2C2]		= &ri2c2_clk.common.hw,
	[CLK_RCPU_I2CCTRL_RI2C0_BUS]		= &ri2c0_bus_clk.common.hw,
	[CLK_RCPU_I2CCTRL_RI2C1_BUS]		= &ri2c1_bus_clk.common.hw,
	[CLK_RCPU_I2CCTRL_RI2C2_BUS]		= &ri2c2_bus_clk.common.hw,
};
...
static struct clk_hw *k3_ccu_rpmu_hws[] = {
	...
	[CLK_RPMU_RIPC2MSA]		= &ripc2msa_clk.common.hw,
	[CLK_RPMU_RIPC2CP]		= &ripc2cp_clk.common.hw,
	[CLK_RPMU_RIPC2AP]		= &ripc2ap_clk.common.hw,
	[CLK_RPMU_RTIMER1]		= &rtimer1_clk.common.hw,
	[CLK_RPMU_RTIMER2]		= &rtimer2_clk.common.hw,
	[CLK_RPMU_RTIMER3]		= &rtimer3_clk.common.hw,
	[CLK_RPMU_RTIMER4]		= &rtimer4_clk.common.hw,
	[CLK_RPMU_RTIMER1_BUS]		= &rtimer1_bus_clk.common.hw,
	[CLK_RPMU_RTIMER2_BUS]		= &rtimer2_bus_clk.common.hw,
	[CLK_RPMU_RTIMER3_BUS]		= &rtimer3_bus_clk.common.hw,
	[CLK_RPMU_RTIMER4_BUS]		= &rtimer4_bus_clk.common.hw,
	[CLK_RPMU_RT24_CORE0]		= &rt24_core0_clk.common.hw,
	[CLK_RPMU_RT24_CORE1]		= &rt24_core1_clk.common.hw,
	[CLK_RPMU_RGPIO]		= &rgpio_clk.common.hw,
	[CLK_RPMU_RGPIO_EDGE]		= &rgpio_edge_clk.common.hw,
	[CLK_RPMU_RGPIO_LP]		= &rgpio_lp_clk.common.hw,
};

static const struct spacemit_ccu_data k3_ccu_rpmu_data = {
	.reset_name	= "rpmu-reset",
	.hws		= k3_ccu_rpmu_hws,
	.num		= ARRAY_SIZE(k3_ccu_rpmu_hws),
};

static struct clk_hw *k3_ccu_rcpu_pwmctrl_hws[] = {
	[CLK_RCPU_PWMCTRL_RPWM0]	= &rpwm0_clk.common.hw,
	[CLK_RCPU_PWMCTRL_RPWM1]	= &rpwm1_clk.common.hw,
	[CLK_RCPU_PWMCTRL_RPWM2]	= &rpwm2_clk.common.hw,
	[CLK_RCPU_PWMCTRL_RPWM3]	= &rpwm3_clk.common.hw,
	[CLK_RCPU_PWMCTRL_RPWM4]	= &rpwm4_clk.common.hw,
	[CLK_RCPU_PWMCTRL_RPWM5]	= &rpwm5_clk.common.hw,
	[CLK_RCPU_PWMCTRL_RPWM6]	= &rpwm6_clk.common.hw,
	[CLK_RCPU_PWMCTRL_RPWM7]	= &rpwm7_clk.common.hw,
	[CLK_RCPU_PWMCTRL_RPWM8]	= &rpwm8_clk.common.hw,
	[CLK_RCPU_PWMCTRL_RPWM9]	= &rpwm9_clk.common.hw,
	[CLK_RCPU_PWMCTRL_RPWM0_BUS]	= &rpwm0_bus_clk.common.hw,
	[CLK_RCPU_PWMCTRL_RPWM1_BUS]	= &rpwm1_bus_clk.common.hw,
	[CLK_RCPU_PWMCTRL_RPWM2_BUS]	= &rpwm2_bus_clk.common.hw,
	[CLK_RCPU_PWMCTRL_RPWM3_BUS]	= &rpwm3_bus_clk.common.hw,
	[CLK_RCPU_PWMCTRL_RPWM4_BUS]	= &rpwm4_bus_clk.common.hw,
	[CLK_RCPU_PWMCTRL_RPWM5_BUS]	= &rpwm5_bus_clk.common.hw,
	[CLK_RCPU_PWMCTRL_RPWM6_BUS]	= &rpwm6_bus_clk.common.hw,
	[CLK_RCPU_PWMCTRL_RPWM7_BUS]	= &rpwm7_bus_clk.common.hw,
	[CLK_RCPU_PWMCTRL_RPWM8_BUS]	= &rpwm8_bus_clk.common.hw,
...
static const struct of_device_id of_k3_ccu_match[] = {
	...
	},
	{
		...
		.data		= &k3_ccu_rcpu_sysctrl_data,
	},
	{
		.compatible	= "spacemit,k3-syscon-rcpu-uartctrl",
		.data		= &k3_ccu_rcpu_uartctrl_data,
	},
	{
	...
	},
	{
		...
		.data		= &k3_ccu_rcpu_spictrl_data,
	},
	{
		.compatible	= "spacemit,k3-syscon-rcpu-i2cctrl",
		.data		= &k3_ccu_rcpu_i2cctrl_data,
	},
	{
