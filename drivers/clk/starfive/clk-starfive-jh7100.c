...
static const struct jh7100_clk_data jh7100_clk_data[] __initconst = {
	...
	JH7100_GATE(JH7100_CLK_SGDMA1P_AXI, "sgdma1p_axi", CLK_IGNORE_UNUSED, JH7100_CLK_SGDMA1P_BUS),
	JH7100_GATE(JH7100_CLK_DMA1P_AXI, "dma1p_axi", CLK_IGNORE_UNUSED, JH7100_CLK_SGDMA1P_BUS),
				     ...
				     struct clk_rate_request *req)
{
	...
	unsigned long div = min(DIV_ROUND_UP(parent, rate), (unsigned long)clk->max_div);
