...
#elifdef CONFIG_SOC_SPACEMIT_K3
...
static const struct ccu_reset_data k3_apbc_resets[] = {
	...
	[RESET_APBC_IPC_AP2AUD]	= RESET_DATA(APBC_IPC_AP2AUD_CLK_RST,	BIT(2), 0),
...
static const struct ccu_reset_data k3_apmu_resets[] = {
	...
	[RESET_APMU_UCIE]	= RESET_DATA(APMU_UCIE_CTRL, 0, BIT(1) | BIT(2) | BIT(3)),
	...
	[RESET_APMU_PCIE_PORTA_MSTR]	= RESET_DATA(APMU_PCIE_CLK_RES_CTRL_A,	0, BIT(5)),
	[RESET_APMU_PCIE_PORTA_SLV]	= RESET_DATA(APMU_PCIE_CLK_RES_CTRL_A,	0, BIT(4)),
	[RESET_APMU_PCIE_PORTA_DBI]	= RESET_DATA(APMU_PCIE_CLK_RES_CTRL_A,	0, BIT(3)),
	[RESET_APMU_PCIE_PORTB_MSTR]	= RESET_DATA(APMU_PCIE_CLK_RES_CTRL_B,	0, BIT(5)),
	[RESET_APMU_PCIE_PORTB_SLV]	= RESET_DATA(APMU_PCIE_CLK_RES_CTRL_B,	0, BIT(4)),
	[RESET_APMU_PCIE_PORTB_DBI]	= RESET_DATA(APMU_PCIE_CLK_RES_CTRL_B,	0, BIT(3)),
	[RESET_APMU_PCIE_PORTC_MSTR]	= RESET_DATA(APMU_PCIE_CLK_RES_CTRL_C,	0, BIT(5)),
	[RESET_APMU_PCIE_PORTC_SLV]	= RESET_DATA(APMU_PCIE_CLK_RES_CTRL_C,	0, BIT(4)),
	[RESET_APMU_PCIE_PORTC_DBI]	= RESET_DATA(APMU_PCIE_CLK_RES_CTRL_C,	0, BIT(3)),
	[RESET_APMU_PCIE_PORTD_MSTR]	= RESET_DATA(APMU_PCIE_CLK_RES_CTRL_D,	0, BIT(5)),
	[RESET_APMU_PCIE_PORTD_SLV]	= RESET_DATA(APMU_PCIE_CLK_RES_CTRL_D,	0, BIT(4)),
	[RESET_APMU_PCIE_PORTD_DBI]	= RESET_DATA(APMU_PCIE_CLK_RES_CTRL_D,	0, BIT(3)),
	[RESET_APMU_PCIE_PORTE_MSTR]	= RESET_DATA(APMU_PCIE_CLK_RES_CTRL_E,	0, BIT(5)),
	[RESET_APMU_PCIE_PORTE_SLV]	= RESET_DATA(APMU_PCIE_CLK_RES_CTRL_E,	0, BIT(4)),
	[RESET_APMU_PCIE_PORTE_DBI]	= RESET_DATA(APMU_PCIE_CLK_RES_CTRL_E,	0, BIT(3)),
...
static const struct ccu_reset_controller_data k3_rsysctrl_reset_data = {
...
static const struct ccu_reset_controller_data k3_ruartctrl_reset_data = {
...
static const struct ccu_reset_controller_data k3_ri2sctrl_reset_data = {
...
static const struct ccu_reset_controller_data k3_rspictrl_reset_data = {
...
static const struct ccu_reset_controller_data k3_ri2cctrl_reset_data = {
...
static const struct ccu_reset_controller_data k3_rpmu_reset_data = {
...
static const struct ccu_reset_controller_data k3_rpwmctrl_reset_data = {
...
#define K3_AUX_DEV_ID(_unit) \
	{ \
		.name = "spacemit_ccu_k3." #_unit "-reset", \
...
static struct auxiliary_driver spacemit_reset_driver = {
	.probe          = spacemit_reset_probe,
	.id_table       = spacemit_reset_ids,
};
module_auxiliary_driver(spacemit_reset_driver);
