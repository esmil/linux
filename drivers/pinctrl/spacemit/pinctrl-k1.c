...
static struct spacemit_pin_drv_strength spacemit_k3_1v8_ds_tbl[16] = {
	{ 0,  2 },
	{ 1,  4 },
	{ 2,  6 },
	{ 3,  7 },
...
static struct spacemit_pin_drv_strength spacemit_k3_3v3_ds_tbl[16] = {
	{ 0,  3 },
	{ 1,  5 },
	{ 2,  7 },
	{ 3,  9 },
...
static const struct spacemit_pinctrl_data k3_pinctrl_data = {
	...
	.variant = {
		...
		.ds_1v8_tbl = spacemit_k3_1v8_ds_tbl,
		.ds_1v8_tbl_num = ARRAY_SIZE(spacemit_k3_1v8_ds_tbl),
		.ds_3v3_tbl = spacemit_k3_3v3_ds_tbl,
		.ds_3v3_tbl_num = ARRAY_SIZE(spacemit_k3_3v3_ds_tbl),
	}
};
