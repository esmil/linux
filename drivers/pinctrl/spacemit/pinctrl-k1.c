...
static const struct pinctrl_pin_desc k3_pin_desc[] = {
	...
	PINCTRL_PIN(143, "QSPI_CLK"),
	PINCTRL_PIN(144, "QSPI_CS1"),
...
static const struct spacemit_pin k3_pin_data[ARRAY_SIZE(k3_pin_desc)] = {
	...
	/* GPIO4 bank */
	K1_FUNC_PIN(76, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(77, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(78, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(79, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(80, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(81, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(82, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(83, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(84, 0, IO_TYPE_1V8),
	...
	K1_FUNC_PIN(91, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(92, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(93, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(94, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(95, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(96, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(97, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(98, 0, IO_TYPE_1V8),

	/* GPIO5 bank */
	K1_FUNC_PIN(99, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(100, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(101, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(102, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(103, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(104, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(105, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(106, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(107, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(108, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(109, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(110, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(111, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(112, 0, IO_TYPE_1V8),
	K1_FUNC_PIN(113, 0, IO_TYPE_1V8),
	...
	/* SD/MMC1 */
	K1_FUNC_PIN(132, 1, IO_TYPE_1V8),
	K1_FUNC_PIN(133, 1, IO_TYPE_1V8),
	K1_FUNC_PIN(134, 1, IO_TYPE_1V8),
	K1_FUNC_PIN(135, 1, IO_TYPE_1V8),
	K1_FUNC_PIN(136, 1, IO_TYPE_1V8),
	K1_FUNC_PIN(137, 1, IO_TYPE_1V8),

	/* QSPI */
	K1_FUNC_PIN(138, 1, IO_TYPE_1V8),
	K1_FUNC_PIN(139, 1, IO_TYPE_1V8),
	K1_FUNC_PIN(140, 1, IO_TYPE_1V8),
	K1_FUNC_PIN(141, 1, IO_TYPE_1V8),
	K1_FUNC_PIN(142, 1, IO_TYPE_1V8),
	K1_FUNC_PIN(143, 1, IO_TYPE_1V8),
	K1_FUNC_PIN(144, 1, IO_TYPE_1V8),
