...
#else
#define V2D_MMU_TTBLR_BASE         (0x80)
#define V2D_MMU_TTBHR_BASE         (0x84)
#define V2D_MMU_TCR0_BASE          (0x88)
#define V2D_MMU_TCR1_BASE          (0x8c)
#define V2D_MMU_TBU_STATUS_BASE    (0x90)
#define V2D_MMU_TBUx_STEP          (0x20)
#define V2D_MMU_BVA_LO             (0x00)
#define V2D_MMU_BVA_HI             (0x04)
#define V2D_MMU_TIMEOUT_PA_ADDR_LO (0x08)
#define V2D_MMU_TIMEOUT_PA_ADDR_HI (0x0C)
#define V2D_MMU_TIMEOUT_VALUE      (0x10)
#define V2D_MMU_CLK_GATING_AUTO_EN (0x14)
#define V2D_MMU_IRQ_STATUS         (0x18)
#define V2D_MMU_IRQ_ENABLE         (0x1C)
#define V2D_MMU_TIMEOUT_VA_ADDR_LO (0x20)
#define V2D_MMU_TIMEOUT_VA_ADDR_HI (0x24)
#define V2D_MMU_LAST_RD_VA_ADDR_LO (0x28)
#define V2D_MMU_LAST_RD_VA_ADDR_HI (0x2C)
#define V2D_MMU_LAST_RD_PA_ADDR_LO (0x30)
#define V2D_MMU_LAST_RD_PA_ADDR_HI (0x34)
#define V2D_MMU_LAST_WR_VA_ADDR_LO (0x38)
#define V2D_MMU_LAST_WR_VA_ADDR_HI (0x3C)
#define V2D_MMU_LAST_WR_PA_ADDR_LO (0x40)
#define V2D_MMU_LAST_WR_PA_ADDR_HI (0x44)
#define V2D_MMU_DMAC               (0x48)
#define V2D_MMU_DMAC_DEBUG_INFO    (0x4C)
#endif
#define TBU_NUM 3
