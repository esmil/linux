 ...
 * Return: 0 on success, else error code.
 */
int mvx_v4l2_session_get_color_desc(struct mvx_v4l2_session *vsession, struct v4l2_mvx_color_desc *color_desc);
...
int mvx_v4l2_session_set_color_desc(struct mvx_v4l2_session *vsession, struct v4l2_mvx_color_desc *color_desc);
