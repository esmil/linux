...
#define vb2_v4l2_to_mvx_v4l2_buffer(v4l2) container_of(v4l2, struct mvx_v4l2_buffer, vb2_v4l2_buffer)

#define vb2_to_mvx_v4l2_buffer(vb2) vb2_v4l2_to_mvx_v4l2_buffer(to_vb2_v4l2_buffer(vb2))
