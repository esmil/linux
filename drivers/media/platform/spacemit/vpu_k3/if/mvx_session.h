...
#define MVX_SESSION_LOG(severity, session, msg, ...)                                                                   \
	MVX_LOG_PRINT_SESSION(&mvx_log_session_if, severity, session, msg, ##__VA_ARGS__)

#define MVX_SESSION_VERBOSE(session, msg, ...) MVX_SESSION_LOG(MVX_LOG_VERBOSE, session, msg, ##__VA_ARGS__)
...
#define MVX_SESSION_WARN(session, msg, ...) MVX_SESSION_LOG(MVX_LOG_WARNING, session, msg, ##__VA_ARGS__)
 ...
 */
static inline struct mvx_session *mvx_if_session_to_session(struct mvx_if_session *session)
{
...
int mvx_session_set_bitrate_control(struct mvx_session *session, struct mvx_buffer_param_rate_control *rc_type);
/**
 ...
 * Return: 0 in case of success, error code otherwise.
 */
int mvx_session_set_i_frame_qp(struct mvx_session *session, enum mvx_format format, int qp);
 ...
 * Return: 0 in case of success, error code otherwise.
 */
int mvx_session_set_p_frame_qp(struct mvx_session *session, enum mvx_format format, int qp);
 ...
 * Return: 0 in case of success, error code otherwise.
 */
int mvx_session_set_b_frame_qp(struct mvx_session *session, enum mvx_format format, int qp);
 ...
 * Return: 0 in case of success, error code otherwise.
 */
int mvx_session_set_min_qp(struct mvx_session *session, enum mvx_format format, int qp);
 ...
 * Return: 0 in case of success, error code otherwise.
 */
int mvx_session_set_max_qp(struct mvx_session *session, enum mvx_format format, int qp);
...
void generate_quant_tbl(int quality, const uint8_t qtbl_ref[MVX_FW_QUANT_LEN], uint8_t qtbl[MVX_FW_QUANT_LEN]);
