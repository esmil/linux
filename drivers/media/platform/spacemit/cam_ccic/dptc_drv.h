...
//#define DPTC_I2C_PORT  1 //8
#define DPTC_I2C_PORT 2 //for zynq
#define DPTC_I2C_PORT_1 4 //for zynq
...
void dptc_csi_reg_setting(u32 id, u8 RAW_type, u32 sensor_width,
			  u32 sensor_height, u8 csi_lanes);
