...
#ifndef _CCIC_HWREG_H_
#define _CCIC_HWREG_H_
...
#define IRQ_SHADOW_NOT_RDY \
	(BIT(5)) /* Shadow bit not ready at frame start IRQ */
...
#define IRQ_CSI2IDI_HBLK2HSYNC \
	(BIT(10)) /* HBLK_TO_HSYNC IRQ, CSI2IDI module detects Hblank to Hsync gap too small */
...
#define IRQ_DPHY_LN_TX_SYNC_ERR \
	(BIT(16)) /* DPHY Lane Start of Transmission Sync Error IRQ */
#define IRQ_DPHY_LN_TX_ERR \
	(BIT(17)) /* DPHY Lane Start of Transmission Error IRQ */
...
#define FRAMEIRQS (IRQ_CSI_SOF)
#define CSI2PHYERRS (0xff0b0840)
...
#define CSI2_VCCTRL_DT_PASS_MASK (0x1 << 24)
#define REG_CSI2_VCCTRL2 0x118
#define CSI2_VCCTRL_DT2_MASK (0x3f << 0)
#define CSI2_VCCTRL_VC2_MASK (0x3 << 6)
#define CSI2_VCCTRL_DT3_MASK (0x3f << 8)
#define CSI2_VCCTRL_VC3_MASK (0x3 << 14)
#define REG_CSI2_DT_FLT 0x11c
#define CSI2_DT_FLT0_EN_MASK (0x1 << 6)
#define CSI2_DT_FLT0_PATTERN_MASK (0x3f << 0)
#define CSI2_DT_FLT1_EN_MASK (0x1 << 14)
#define CSI2_DT_FLT1_PATTERN_MASK (0x3f << 8)
#define CSI2_DT_FLT2_EN_MASK (0x1 << 22)
#define CSI2_DT_FLT2_PATTERN_MASK (0x3f << 16)
#define CSI2_DT_FLT3_EN_MASK (0x1 << 30)
#define CSI2_DT_FLT3_PATTERN_MASK (0x3f << 24)
#define REG_CSI2_DT_FLT2 0x120
#define CSI2_DT_FLT4_EN_MASK (0x1 << 6)
#define CSI2_DT_FLT4_PATTERN_MASK (0x3f << 0)
#define CSI2_DT_FLT5_EN_MASK (0x1 << 14)
#define CSI2_DT_FLT5_PATTERN_MASK (0x3f << 8)
#define CSI2_DT_FLT6_EN_MASK (0x1 << 22)
#define CSI2_DT_FLT6_PATTERN_MASK (0x3f << 16)
#define CSI2_DT_FLT7_EN_MASK (0x1 << 30)
#define CSI2_DT_FLT7_PATTERN_MASK (0x3f << 24)
...
#define REG_CSI2_DPHY9 0x32c
#define CSI2_DHPY9_EN_BIF2 (0x1 << 23)
