...
#define RPMI_SRVGRP_REGULATOR		0x00007
#define RPMI_SRVGRP_CLOCK		0x00008
#define RPMI_SRVGRP_DEVICE_POWER	0x00009

/** RPMI voltage service IDs */
enum rpmi_regulator_service_id {
	RPMI_REGULATOR_SRV_ENABLE_NOTIFICATION = 0x01,
	RPMI_REGULATOR_SRV_GET_NUM_DOMAINS = 0x02,
	RPMI_REGULATOR_SRV_GET_ATTRIBUTES = 0x03,
	RPMI_REGULATOR_SRV_GET_SUPPORTED_LEVELS = 0x04,
	RPMI_REGULATOR_SRV_SET_CONFIG = 0x05,
	RPMI_REGULATOR_SRV_GET_CONFIG = 0x06,
	RPMI_REGULATOR_SRV_SET_LEVEL = 0x07,
	RPMI_REGULATOR_SRV_GET_LEVEL = 0x08,
	RPMI_REGULATOR_SRV_ID_MAX_COUNT,
};
